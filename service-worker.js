const CACHE_NAME = "angels-v16-2026-07-12";
const FILES = ["./","./index.html","./styles.css?v=16","./app.js?v=16","./manifest.webmanifest","./assets/logo-angels.svg","./assets/hero-pets.svg","./assets/gallery-1.svg","./assets/gallery-2.svg","./assets/gallery-3.svg"];
